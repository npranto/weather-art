...
const getForecastForNext10Days = (coordinates) => {
    return fetch(`http://api.wunderground.com/api/${process.env.REACT_APP_WU_DEV_API_KEY}/forecast10day/q/${coordinates.latitude},${coordinates.longitude}.json`)
