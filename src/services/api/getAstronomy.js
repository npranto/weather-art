...
const getAstronomy = (coordinates) => {
	return fetch(`http://api.wunderground.com/api/${process.env.REACT_APP_WU_DEV_API_KEY}/astronomy/q/${coordinates.latitude},${coordinates.longitude}.json`)
