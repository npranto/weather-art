...
const getTodaysForecast = (coordinates) => {
    return fetch(`http://api.wunderground.com/api/${process.env.REACT_APP_WU_DEV_API_KEY}/forecast/q/${coordinates.latitude},${coordinates.longitude}.json`)
